/****************************************************************************
 * DroneHub GCS — Fly View widget layer (collapsible left tool strip + right camera panel).
 ****************************************************************************/
...
Item {
    ...
    QGCToolInsets {
        ...
        rightEdgeTopInset:      Math.max(topRightPanel.visible ? topRightPanel.rightEdgeTopInset : 0,
                                    topRightColumnLayout.rightEdgeTopInset)
        rightEdgeCenterInset:   Math.max(topRightPanel.visible ? topRightPanel.rightEdgeCenterInset : 0,
                                    topRightColumnLayout.rightEdgeCenterInset)
        rightEdgeBottomInset:   bottomRightRowLayout.rightEdgeBottomInset
        topEdgeLeftInset:       toolStrip.topEdgeLeftInset
        topEdgeCenterInset:     mapScale.topEdgeCenterInset
        topEdgeRightInset:      Math.max(topRightPanel.visible ? topRightPanel.topEdgeRightInset : 0,
    ...
    FlyViewTopRightColumnLayout {
        ...
        visible:            !topRightPanel.visible
                            ...
                            && Theme.flyCameraPanelExpanded
        enabled:            Theme.flyCameraPanelExpanded
        opacity:            Theme.flyCameraPanelExpanded ? 1.0 : 0.0
        scale:              Theme.flyCameraPanelExpanded ? 1.0 : 0.96
        transformOrigin:    Item.TopRight
        Behavior on opacity { NumberAnimation { duration: 160; easing.type: Easing.OutCubic } }
        Behavior on scale { NumberAnimation { duration: 160; easing.type: Easing.OutCubic } }

        property bool _panelOpen: !topRightPanel.visible
                && !QGroundControl.videoManager.fullScreen
                && Theme.flyCameraPanelExpanded
        property real topEdgeRightInset:    _panelOpen ? childrenRect.height + _layoutMargin : 0
        property real rightEdgeTopInset:    _panelOpen ? width + _layoutMargin : 0
        property real rightEdgeCenterInset: rightEdgeTopInset
    }
    ...
    Loader {
        ...
        readonly property bool _pipActive:     parentToolInsets
                                                    && parentToolInsets.bottomEdgeLeftInset > 0
        property var  _pipViewMargin:          _pipActive
    ...
    FlyViewToolStrip {
        ...
        visible:                !QGroundControl.videoManager.fullScreen && Theme.flyToolStripExpanded
        enabled:                Theme.flyToolStripExpanded
        opacity:                Theme.flyToolStripExpanded ? 1.0 : 0.0
        scale:                  Theme.flyToolStripExpanded ? 1.0 : 0.96
        ...
        property bool _stripOpen: Theme.flyToolStripExpanded
                && !QGroundControl.videoManager.fullScreen
        property real topEdgeLeftInset:     _stripOpen ? y + height : 0
        property real leftEdgeTopInset:     _stripOpen ? x + width : 0
